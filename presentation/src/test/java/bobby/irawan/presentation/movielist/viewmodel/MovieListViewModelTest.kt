package bobby.irawan.presentation.movielist.viewmodel
...
import bobby.irawan.ministockbit.domain.repository.Repository
...
import bobby.irawan.ministockbit.presentation.movielist.viewmodel.MovieListViewModel
import bobby.irawan.ministockbit.presentation.movielist.viewmodel.MovieState
import bobby.irawan.presentation.schedulers.TestingPostExecutionThread
import bobby.irawan.presentation.schedulers.TestingThreadExecutor
...
class MovieListViewModelTest {
    ...
    private fun setUpThreadForRxJava() {
        threadExecutor =
            TestingThreadExecutor()
        postExecutionThread =
            TestingPostExecutionThread()
    }
    ...
    fun fetchMoviesList_returnsError() {
        // Arrange
        stubFetchMovies(Single.error(
            TestingException(
                TestingException.GENERIC_EXCEPTION_MESSAGE
            )
        ))
