...
import bobby.irawan.ministockbit.data.store.MovieCacheDataStore
import bobby.irawan.ministockbit.data.store.MovieDataStoreFactory
...
class MovieDataStoreFactoryTest {
    ...
    fun setUp() {
        movieCacheDataStore =
            MovieCacheDataStore(movieCache)
