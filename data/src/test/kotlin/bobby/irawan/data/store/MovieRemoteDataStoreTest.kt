package bobby.irawan.data.store

import bobby.irawan.data.factory.DataFactory
import bobby.irawan.data.factory.movie_entity.MovieEntityFactory
import bobby.irawan.ministockbit.data.models.MovieEntity
import bobby.irawan.ministockbit.data.repository.MoviesRemote
import bobby.irawan.ministockbit.data.store.MovieRemoteDataStore
...
class MovieRemoteDataStoreTest {
    ...
    fun setUp() {
        movieRemoteDataStore =
            MovieRemoteDataStore(movieRemote)
    }
